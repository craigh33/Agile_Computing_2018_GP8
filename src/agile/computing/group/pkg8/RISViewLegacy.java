 ...
 * @author Ryan
 */
public class RISViewLegacy extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RISView
     */
    public RISViewLegacy() {
        initComponents();
    ...
    private void getDataForList()
    {
        ...
        try {
            while (rs2.next()) {
                ...
                if (rs2.getString("researcher_Sig").equals("0") && rs2.getString("ris_sig").equals("0") && rs2.getString("depDean_sig").equals("0") && rs2.getString("dean_sig").equals("0"))
                    {
                    //add to list in here 
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Signed in as: RIS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RISViewLegacy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RISViewLegacy().setVisible(true);
            }
        });
    }
