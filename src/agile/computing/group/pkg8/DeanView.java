...
public class DeanView extends javax.swing.JFrame {
    ...
    private void projects_ListMouseClicked(java.awt.event.MouseEvent evt) {                                           
        try {
    ...
    private void projectName_txtboxActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        
    }                                                  

    private void export_PDF_btnMouseClicked(java.awt.event.MouseEvent evt) {                                            
    ...
    private void sign_buttonMouseClicked(java.awt.event.MouseEvent evt) {                                         
    ...
    private void download_btnMouseClicked(java.awt.event.MouseEvent evt) {                                          
